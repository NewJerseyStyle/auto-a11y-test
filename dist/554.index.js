 ...
 */
class SequentialChain extends base/* BaseChain */.r {
    static lc_name() {
    ...
    static async deserialize(data) {
        ...
        for (const serializedChain of serializedChains) {
            const deserializedChain = await base/* BaseChain */.r.deserialize(serializedChain);
 ...
 * ```
 */
class SimpleSequentialChain extends base/* BaseChain */.r {
    static lc_name() {
